               ...
               // NSArray *array = [rootele elementsForName:@"package"];
                ...
                for (GDataXMLElement *xmlData in array)
                {
                   ...
                   // lastPath = [rootPath stringByAppendingPathComponent:lastPath];
                    ...
                    model.idiomExplain = [model.idiomExplain stringByReplacingOccurrencesOfString:@"'" withString:@"‘"];
                    model.idiomFrom = [model.idiomFrom stringByReplacingOccurrencesOfString:@"'" withString:@"‘"];
                    model.idiomAnswer = [model.idiomAnswer stringByReplacingOccurrencesOfString:@"'" withString:@"‘"];
                   ...
                   // model.idiomImageName = [NSString stringWithFormat:@""];
                    ...
                    DLOG(@"path:%@",model.idiomImageName);
